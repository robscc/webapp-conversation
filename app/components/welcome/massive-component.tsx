...
export const AppInfoComp: FC<{ siteInfo: AppInfo }> = ({ siteInfo }) => {
  ...
  return (
    <div>
      ...
      <div className='flex items-center py-2 text-xl font-medium text-gray-700 rounded-md'>👏 Hi, Welcome to {siteInfo.title}, nice to meet you! Please copy and paste your participant ID from CloudReesarch Connect Platform</div>
